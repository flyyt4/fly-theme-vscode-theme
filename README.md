# Fly theme - SynthWave '84 - VS Code theme

Un tema de vs code en bace a Synthwave '84 todos los derechos reservados a 

# Synthwave '84 description

![fly theme  Synthwave '84](./banner.png)
...
__As of v0.1.0, no external extensions are needed to activate the glow effect! (the preview is of fly theme not of Synthwave '84)__
